...
/*
 * `DATASET_GROUPS` y `presentDatasets` se mudaron a `packages/db/src/services/datasets.ts`
 * porque el worker también los necesita: un análisis encolado tiene que declarar sus fuentes
 * igual que uno inmediato. Se reexportan para que las rutas sigan importándolos de aquí.
 */
export { DATASET_GROUPS, presentDatasets } from '@terracolombia/db';
export type { DatasetScope } from '@terracolombia/db';
